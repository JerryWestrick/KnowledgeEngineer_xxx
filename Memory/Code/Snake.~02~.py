...
def detect_collision(snake_head, snake_body, game_area):
    """
    ...
    - snake_body: A list of tuples representing the segments of the snake's body, excluding the head.
    - game_area: A tuple representing the width and height of the game area.
    """
    x, y = snake_head
    width, height = game_area
